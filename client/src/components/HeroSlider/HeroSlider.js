...
export default function HeroSlider() {
    ...
    return (
        <div ref={slideRef} className=' w-full select-none overflow-hidden relative'>
            <img className='min-w-min ml-[50%] -translate-x-1/2' src={heroImages[currentIndex]} alt="/images/Clothes 4Crew Logo.jpg" />
