        ...
        <nav className="w-full h-1/6 mt-2  bg-white shadow-md flex flex-col justify-around ">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-3">
                    ...
                    {/* Login */}
                    <button onClick={loginWithPopup} className="box-border bg-slate-900 text-slate-50 rounded flex p-2 justify-center items-center transition hover:bg-slate-50 hover:text-slate-900 hover:border-2 hover:border-slate-900">
                        👤 Iniciar sesión
                    </button>
