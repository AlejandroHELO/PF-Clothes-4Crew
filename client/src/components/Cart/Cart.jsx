                                                                                    ...
                                                                                    <div className="flex flex-1 justify-between sm:hidden">
                                                                                        ...
                                                                                        1 ? (
                                                                                            <botton
                                                                                                ...
                                                                                                className="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 :disabled:bg-gray"
                                                                                            >
                                                                                                Menos
                                                                                            </botton>
                                                                                        ) : (
