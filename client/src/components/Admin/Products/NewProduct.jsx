        ...
        <div className={st.newUser}>
            ...
            <form onSubmit={handleCreate} className={st.newUserForm}>
                <div className={st.newUserItem}>
                    <label>Name</label>
                    <input type="text" name="name" placeholder='Product name' onChange={(e) => handleChange(e)}/>
                </div>
                <div className={st.newUserItem}>
                    <label>Brand</label>
                    <input type="text" name="brand" placeholder='Product brand' onChange={(e) => handleChange(e)}/>
                </div>
                <div className={st.newUserItem}>
                    <label>Category</label>
                    <input type="text" name="category" placeholder='Accesories, Pants, Shoes...' onChange={(e) => handleChange(e)}/>
                </div>
                <div className={st.newUserItem}>
                    <label>Color</label>
                    <input type="text" name="color" placeholder='Product color' onChange={(e) => handleChange(e)}/>
                </div>
                <div className={st.newUserItem}>
                    <label>Gender</label>
                ...
                <div className={st.newUserItem}>
                    ...
                    <input type="text" name="description" placeholder='Product description' onChange={(e) => handleChange(e)}/>
                </div>
                <div className={st.newUserItem}>
                    <label>Price</label>
                ...
                <div className={st.newUserItem}>
                    <label>Stock</label>
                    <input type="number" name="stock" placeholder='Available stock' onChange={(e) => handleChange(e)}/>
                </div>
                <div className={st.newUserItem}>
                    <label>Sizes</label>
                    <input type="text" name="size" placeholder='Available sizes' onChange={(e) => handleChange(e)}/>
                </div>
                <div className={st.newUserItem}>
                    <label>Active</label>
