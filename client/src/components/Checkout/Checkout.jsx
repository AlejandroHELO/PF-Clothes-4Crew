...
export default function Checkout({id}){
    ...
    const onNextSelect = (e) => {
        e.preventDefault()
        if (addAddress !== 'Select') setpasos(pasos + 1)
    }
    const onBack = (e) => {
        e.preventDefault()
        setpasos(pasos - 1)
    ...
    return (
        <div className="grid h-screen place-items-center my-10 mx-10">
            {pasos === 0 ? (
                    ...
                    <div className={st.userContainer}>
                        <div className={st.userShow}>
                            <Select
                                ...
                                onChange={onSelect}
                            >
                                <MenuItem defaultOpen={true} value="Select">
                                    Select
                                </MenuItem>
                                {address.msj || address === ''
                                    ? null
                            ...
                            {addAddress === 'Select' ? (
                                <p>
                                    please choose one of the available addresses
                            ...
                            addAddress !== 'create' ? (
                                <div>
                                    <div className={st.userShowInfo}>
                                        <span className={st.userShowInfoTitle}>
                                            Street:{' '}
                                            {addressFilter(addAddress).street}
                                        </span>
                                    </div>
                                    <hr />
                                    <div className={st.userShowInfo}>
                                    ...
                                    <div className={st.userShowInfo}>
                                        <span className={st.userShowInfoTitle}>
                                            Country:{' '}
                                            {addressFilter(addAddress).country}
                                        </span>
                                    </div>
                                    <hr />
                                    <div className={st.userShowInfo}>
                ...
                <div className="content-center">
                    <div
                        className={`${st.userTitleContainer} place-items-center`}
                    >
                    ...
                    <div className={st.userContainer}>
                        <div className={st.userShow}>
                            {cart.length
                                ...
                                : null}
                            <span className="my-10">Total: {total}</span>
                            <br />
                            <div className="flex">
                                <button
                                ...
                                {props && addAddress ? (
                                    <Pago id={props.id} address={addAddress} />
                                ) : null}
                            </div>
                        </div>
                    </div>
