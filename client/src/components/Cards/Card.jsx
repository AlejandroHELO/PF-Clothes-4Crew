...
const Card = (p) => {
    return (
        <div
            className=" w-48 h-80 shadow-2xl m-2 flex flex-col items-center justify-between"
            key={p.id}
        >
            <div>
                {p.image.length !== 0 ? (
                    <div>
                        {
                            <img
                                className="w-36 hover:transition ease-in-out delay-750 duration-1000 hover:w-44   "
                                src={p.image[0]}
                                alt="image"
                            />
                        }
