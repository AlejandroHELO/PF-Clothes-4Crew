...
export const POST_DBCART = 'POST_DBCART'
export const POST_DBCARTD = 'POST_DBCARTD'
export const POST_ADDRESS_ID = 'POST_ADDRESS_ID'
export const DELETE_CREATE_PURCHASE = 'DELETE_CREATE_PURCHASE'
export const GET_CREATE_PURCHASE = 'GET_CREATE_PURCHASE'
export const GET_PURCHASES = 'GET_PURCHASES'
export const POST_CREATE_PURCHASE = 'POST_CREATE_PURCHASE'
...
export const OPEN_MENU_MOVIL_FILTERS = 'OPEN_MENU_MOVIL_FILTERS'